...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       /* $coupon = new Coupon;
        ...
        $coupon->img = Helpers::upload('coupon/', 'png', $request->file('image'));
        $coupon->save();*/
       ...
       DB::table('coupons')->insert([
            ...
            'created_at' => now(),
            'updated_at' => now(),
            'img'=> Helpers::upload('coupon/', 'png', $request->file('image')),
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('coupons')->where(['id' => $id])->update([
            ...
            'data' => json_encode($data),
            'updated_at' => now(),
            'img' =>$request->has('image') ? Helpers::update('coupon/', $coupon->image, 'png', $request->file('image')) : $coupon->image,
