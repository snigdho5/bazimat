...
class CouponController extends Controller
{
    ...
    {
        $img=url('')."/storage/app/public/coupon/";
        try {
            $coupon = Coupon::active()->get();
            return response()->json(['state'=> 0,'errors' =>$coupon ,'coverimg' =>url('')."/storage/app/public/coupon/"], 200);
        } catch (\Exception $e) {
            return response()->json(['state'=> 1,'errors' => $e], 200);
        }
    }
