...
class CustomerAuthController extends Controller
{
    ...
    public function check_email(Request $request)
    {
        ...
        // $email_verify = BusinessSetting::where(['key'=>'email_verification'])->first();

        // if (!empty($email_verify) && $email_verify->value){
    ...
    public function register(Request $request)
    {
        ...
        if($customer_verification && env('APP_MODE') !='demo')
        {
            ...
            {
                $errors = [];
                array_push($errors, ['code' => 'otp','state' => 1, 'message' => trans('messages.faield_to_send_sms')]);
                return response()->json([
                    'state' => 0,
                    'errors' => $errors
                ], 200);
        ...
        return response()->json(['state' => 0,'token' => $token,'is_phone_verified' => 0, 'message' =>"Sucessful", 'phone_verify_end_url'=>"api/v1/auth/verify-phone"], 200);
    ...
    public function login(Request $request)
    {
        ...
        if (auth()->attempt($data)) {
            ...
            return response()->json(['token' => $token, 'state' => 0,'is_phone_verified'=>auth()->user()->is_phone_verified], 200);
        } else {
            $errors = [];
