...
class ProductLogic
{
    ...
    public static function get_latest_products($limit = null, $offset = null, $restaurant_id)
    {
        ...
        $products = Food::select('id','name','description','image','category_id',
         'price','tax','tax_type','discount','discount_type','available_time_starts','available_time_ends','status','restaurant_id')
          ->active()->where('restaurant_id', $restaurant_id)->latest()->get();
    ...
    public static function popular_products($zone_id, $limit = null, $offset = null)
    {
       ...
       /* $paginator = Food::select('id','name','description','image','category_id',
         'price','tax','tax_type','discount','discount_type','available_time_starts','available_time_ends','status','restaurant_id')
