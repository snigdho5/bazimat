                        ...
                        <form action="{{route('vendor.business-settings.update-setup',[$restaurant['id']])}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
									...
									<div class="form-group">
                                        <label class="input-label text-capitalize" for="title">Details</label>
                                         
										<textarea  class="form-control" name="description" rows="4" cols="50">{{$restaurant->description??''}}</textarea>
                                    </div>
                                   
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group p-2 border">
                                        <label class="input-label text-capitalize" for="title">Offer Price </label>
                                         
										<textarea  class="form-control" name="offerprice" rows="4" cols="50">{{$restaurant->offerprice??''}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
									...
									<div class="form-group">
                                        <label class="input-label text-capitalize" for="title">Discount</label>
                                         
										
										<input type="text" name="discount"  class="form-control" placeholder="100" value="{{$restaurant->discount??'0'}}"> 
                                    </div>
                                   
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group p-2 border">
                                        <label class="input-label text-capitalize" for="title">Offer text</label>
                                         
										<textarea  class="form-control" name="offertext" rows="4" cols="50">{{$restaurant->offertext??''}}</textarea>
