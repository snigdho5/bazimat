                    ...
                    @if($customer)
                        <div class="card-body">
                            ...
                            <div class="media align-items-center" href="javascript:">
                                ...
                                <div class="media-body">
                                    @if($customer['agestatus'] =='0')
                                <span
                                    class="text-body text-hover-primary">Age not verified</span>
                                    @elseif($customer['agestatus'] =='1')
                                    <span
                                    class="text-body text-hover-primary">Age verified</span>
                                    @else
                                    <span
                                    class="text-body text-hover-primary">Waiting for Approval</span>
                                     
                                    
                                    @endif
                                    @if(count($agedetails)>0)
                                    ...
                                    @if($agedetails[0]->id!=='')
                                     <p>
                                        ...
                                        src="{{asset('storage/app/public/age/'.$agedetails[0]->fontimg)}}"
                                        alt="Font image Description" height="200px" width="200px">
                                    </p>
                                     @endif
                                     @if($agedetails[0]->id!=='')
                                    <p>
                                        ...
                                        src="{{asset('storage/app/public/age/'.$agedetails[0]->	backimg)}}"
                                        alt="Back Image" height="200px" width="200px">
                                    </p>
                                      @endif
