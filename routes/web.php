...
Route::get('/', 'HomeController1@index')->name('home');
Route::get('terms-and-conditions', 'HomeController1@terms_and_conditions')->name('terms-and-conditions');
Route::get('about-us', 'HomeController1@about_us')->name('about-us');
Route::get('contact-us', 'HomeController1@contact_us')->name('contact-us');
Route::get('privacy-policy', 'HomeController1@privacy_policy')->name('privacy-policy');
