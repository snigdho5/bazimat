...
Route::group(['namespace' => 'Api\V1'], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware' => ['vendor.api']], function () {
        ...
        Route::post('dashboard', 'VendorController@get_dashboard');
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('/delivery', 'ConfigController@configuration_delivery');
    ...
    Route::group(['prefix' => 'restaurants'], function () {
        ...
        Route::post('cat', 'RestaurantController@get_searched_restaurantscat');
        Route::post('product', 'RestaurantController@get_searched_restaurantspro');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::get('cm-notifications', 'NotificationController@get_cm_notifications');
        ...
        Route::group(['prefix' => 'address'], function () {
            ...
            Route::get('serviceable', 'CustomerController@serviceable_address');
        ...
        Route::group(['prefix' => 'cart'], function () {
            ...
            Route::post('update-cart', 'OrderController@update_cart');
            Route::post('delete-cart', 'OrderController@delete_cart');
        });
